...
<style>
	#nav>li>a.nav-news{background-color: #db2026;color: #fff}
	...
	.list-group-item.active:hover{background: #db2026;border:none;padding-left: 15px;}
...
<!-- 新闻正文 -->
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">新闻中心<span>&nbsp;|&nbsp;News</span></li>
    </ol>
    	...
    	<div class="col-md-3">
    		<div class="list-group">
    		  ...
    		  <c:forEach items="${news }" var="items">
    		  	 <a href="<%=request.getContextPath() %>/news.do?id=${items.id}" class="list-group-item">${items.title }</a>
    		  </c:forEach>
    		</div>
    	</div>
    	<div class="col-md-9">
    		<div class="jumbotron" id="con">
    		  <p class="caption">${newsOne.title }</p>
    		  <p class="context">
    		  	${newsOne.introduce }
    		  	<c:forEach items="${newsOne.newsImages }" var="img">
