...
<body>
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				<form action="<%=request.getContextPath() %>/under/addUnderTake.do" method="post" enctype="multipart/form-data">
			        
			         <div class="input-group" style="margin-top:5%">
			            <span class="input-group-addon" style="border-radius: 0;">承接标题</span>
			            <input type="text" name="title" class="form-control" style="border-radius: 0;" placeholder="承接标题">
			         </div>
			          <div class="input-group" style="margin-top:5%">
			            <span class="input-group-addon" style="border-radius: 0;">承接类型</span>
			            <input type="text" name="type" class="form-control" style="border-radius: 0;" placeholder="承接类型">
			         </div>
			         <br>
			         <textarea name="introduce" id="editor" placeholder="承接内容" autofocus></textarea>
